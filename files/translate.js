...
function changeToSlo() {
    ...
    document.getElementById("us").innerHTML = "Oj! Sem Jaka Černetič, dijak 1. letnika Vegove gimnazije. Trenutno se učim izdelavo spletnih strani, programiranje v JavaScriptu, batchu in C++.";
...
function changeToEng() {
    ...
    document.getElementById("us").innerHTML = "Hi! I'm Jaka Černetič. I'm a student of the first year at Vegova high school. I am currently learning web development, JavaScript, batch and C++.";
